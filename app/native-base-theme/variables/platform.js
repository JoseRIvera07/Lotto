...
export default {
  ...
  // Color
  brandPrimary: platform === PLATFORM.IOS ? '#FB5C43' : '#FB5C43',
  brandInfo: '#62B1F6',
  brandSuccess: '#5cb85c',
  brandDanger: '#d9534f',
  brandWarning: '#f0ad4e',
  ...
  // Footer
  footerHeight: 55,
  footerDefaultBg: platform === PLATFORM.IOS ? '#FB5C43' : '#FB5C43',
  footerPaddingBottom: 0,

  // FooterTab
  tabBarTextColor: platform === PLATFORM.IOS ? '#fff' : '#fff',
  ...
  tabActiveBgColor: platform === PLATFORM.IOS ? '#fff' : '#fff',

  // Header
  toolbarBtnColor: platform === PLATFORM.IOS ? '#fff' : '#fff',
  toolbarDefaultBg: platform === PLATFORM.IOS ? '#FB5C43' : '#FB5C43',
  toolbarHeight: platform === PLATFORM.IOS ? 64 : 75,
  ...
  toolbarDefaultBorder: platform === PLATFORM.IOS ? '#FB5C43' : '#FB5C43',
  ...
  // Icon
  iconFamily: 'Ionicons',
  iconFontSize: platform === PLATFORM.IOS ? 22 : 20,
  ...
  radioSelectedColorAndroid: '#FB5C43',
  ...
  // Segment
  segmentBackgroundColor: platform === PLATFORM.IOS ? '#FB5C43' : '#FB5C43',
  segmentActiveBackgroundColor: platform === PLATFORM.IOS ? '#fff' : '#fff',
  segmentTextColor: platform === PLATFORM.IOS ? '#fff' : '#fff',
  ...
  // Spinner
  defaultSpinnerColor: '#FB5C43',
  inverseSpinnerColor: '#1A191B',

  // Tab
  tabBarDisabledTextColor: '#fff',
  tabDefaultBg: platform === PLATFORM.IOS ? '#FB5C43' : '#FB5C43',
  ...
  titleFontSize: platform === PLATFORM.IOS ? 21 : 24,
